            ...
            <div className="flex bg-background text-foreground h-screen overflow-hidden">
                ...
                <aside className={cn(
                    ...
                    <div className={cn(
                        ...
                        {!isSidebarCollapsed && <h1 className="text-xl font-bold ml-3 text-card-foreground">Painel</h1>}
                    </div>
             ...
             <SheetContent side="left" className="p-0 w-64 bg-card">
                ...
                <div className="flex flex-col h-full">
                    <div className="h-16 flex items-center border-b border-border px-6">
                        <FaWhatsapp className="h-7 w-7 text-primary flex-shrink-0" />
                        <h1 className="text-xl font-bold ml-3 text-card-foreground">Painel</h1>
                    </div>
                    <nav className="flex-1 p-3 space-y-1">
                        <NavButtons isMobile />
                    </nav>
